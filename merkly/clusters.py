...
eps = 100  # maximum distance between two samples to be considered as neighbors (300 seconds = 5 minutes)
...
sorted_clusters.to_csv("data2/Polygon_Clusters.csv", index=False)
